...
/***/ function(module, exports, __webpack_require__) {
	...
	var updatedGame = __webpack_require__(8).updatedGame;
	...
	var startGame = function startGame() {
	  ...
	  var checkWin = function checkWin() {
	    var winArr = [[gameArray[0], gameArray[1], gameArray[2]], [gameArray[3], gameArray[4], gameArray[5]], [gameArray[6], gameArray[7], gameArray[8]], [gameArray[0], gameArray[4], gameArray[8]], [gameArray[2], gameArray[4], gameArray[6]], [gameArray[0], gameArray[3], gameArray[6]], [gameArray[1], gameArray[4], gameArray[7]], [gameArray[2], gameArray[5], gameArray[8]]];
	    for (var i in winArr) {
	  ...
	  $('.inner[data-id]').on('click', function () {
	    ...
	    var update = { cell: { index: this.dataset.id, value: currentPlayer } };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var updatedGame = function updatedGame(data) {
	  return $.ajax({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onGetGames = function onGetGames(event) {
	  event.preventDefault();
	  var data = getFormFields(this);
	  api.getGames(data).then(ui.displayGamesSuccess).catch(ui.displayGamesFailure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var displayGamesSuccess = function displayGamesSuccess(response) {
	...
	var displayGamesFailure = function displayGamesFailure() {
	...
	module.exports = {
	  ...
	  displayGamesSuccess: displayGamesSuccess,
	  displayGamesFailure: displayGamesFailure
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
